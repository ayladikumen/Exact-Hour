...
#
#  Run:  py dev/demo_server.py        (binds 127.0.0.1:8731; from repo root)
#        py dev/demo_server.py 9000   (custom port)
# =============================================================================
...
# This script lives in dev/; add the repo root (its parent dir) to the import
# path so `import remote_control` resolves no matter where it's run from.
